  ...
  return (
    <StyledLotteryCard>
      <CardBody>
        ...
        <Block>
          <Label>{t('Estimated Target Date: Tue Jul 06 2021 02:20:29 GMT+0700 (Indochina Time)')}:</Label>
          <Label>{t('Countdown Link:')}:</Label><a href="https://bscscan.com/block/countdown/8899999">Click Here</a>
        </Block>
